...
export const turkiyenincografikonumu: Topic = {
  ...
  era: "cagdas",
  shortDescription: "Türkiye'nin matematik (mutlak) ve özel (göreceli) konumu, sınır kapıları, komşuları ve jeopolitik önemi.",
  examImportance: 10,
  estimatedMinutes: 60,
  keywords: ["kpss", "coğrafya", "türkiye'nin coğrafi konumu", "matematik konum", "özel konum", "jeopolitik", "sınır kapıları"],
  summary: [
  {
  ...
  mustKnow: [
    ...
    "Orta kuşakta bulunmanın kanıtları cephesel yağışlar, batı rüzgarları, Akdeniz iklimi ve 4 mevsimin belirgin yaşanmasıdır (ABCD).",
    "Gölge boyu Türkiye'de hiçbir zaman sıfır olmaz ve gölge yönü öğle vakti daima kuzeyi gösterir (Yengeç Dönencesi kuzeyindeyiz).",
    "En uzun kara sınırımız Suriye, en kısa kara sınırımız Nahçıvan'dır. En işlek sınır kapılarımız Kapıkule (Bulgaristan) ve Habur (Irak) kapılarıdır.",
    "Türkiye'de batıdan doğuya gidildikçe yükseltinin artması matematik değil, özel (göreceli) konumun bir sonucudur."
  ],
  commonMistakes: [
    "Dört mevsimin yıl içinde belirgin yaşanması matematik konumun (orta kuşak) sonucuyken, aynı anda farklı yerlerde farklı mevsimsel özelliklerin (örneğin Antalya'da denize girilirken Erzurum'da kayak yapılması) yaşanması özel konumun (yükselti ve yer şekilleri) sonucudur.",
    "Iğdır'da pamuk yetişmesi veya Rize'de turunçgil yetişmesi matematik konumla çelişen, özel konumun (mikroklima) getirdiği istisnai durumlardır.",
    "Güneş ışınlarının hiçbir zaman dik gelmemesi Kuzey Yarım Küre'de olmanın değil, dönencelerin dışında (kuzeyinde) olmanın bir sonucudur."
  ],
  quickTimeline: [
    { date: "1639", event: "Kasr-ı Şirin Antlaşması ile bugünkü Türkiye-İran sınırı büyük ölçüde çizildi." },
    { date: "1923", event: "Lozan Barış Antlaşması ile batı ve güney sınırları (Hatay hariç) uluslararası düzeyde tescil edildi." },
    { date: "1939", event: "Hatay Anavatana katıldı ve bugünkü Türkiye-Suriye sınırı son şeklini aldı." },
    { date: "2016", event: "Bakanlar Kurulu kararıyla yaz-kış saati uygulamasına son verilerek yıl boyunca 45° Doğu (Iğdır) saati kalıcı hale getirildi." }
  ]
};
