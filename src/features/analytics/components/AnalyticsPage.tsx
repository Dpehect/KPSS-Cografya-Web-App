  ...
  const feedbackData = useMemo(() => {
    ...
    if (accuracy >= 85) {
      return {
        ...
        body: `Coğrafya sorularında %${accuracy} doğruluk oranına sahipsiniz. Bu oran sınav standartlarının oldukça üzerinde! Bilgilerinizi taze tutmak için karma testlere ve süre sınırına dayalı deneme sınavlarına ağırlık verebilirsiniz.`,
    ...
    return {
      ...
      body: `Mevcut doğruluk oranınız %${accuracy}. KPSS Coğrafya'ta netlerinizi yükseltmek için öncelikle konuların detaylı özetlerini okuyup, ardından kolay ve orta düzey testlerle soru pratiklerinizi pekiştirmeniz faydalı olacaktır.`,
