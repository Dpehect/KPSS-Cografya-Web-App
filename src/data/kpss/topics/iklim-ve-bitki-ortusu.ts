...
export const iklimvebitkiortusu: Topic = {
  id: "iklim-ve-bitki-ortusu",
  slug: "iklim-ve-bitki-ortusu",
  title: "İklim ve Bitki Örtüsü",
  era: "cagdas",
  shortDescription: "Türkiye'nin iklimini etkileyen faktörler, basınç merkezleri, rüzgarlar, iklim tipleri ve bitki örtüsü çeşitliliği.",
  examImportance: 10,
  estimatedMinutes: 60,
  keywords: ["kpss", "coğrafya", "iklim ve bitki örtüsü", "akdeniz iklimi", "karadeniz iklimi", "maki", "bozkır", "rüzgarlar"],
  summary: [
  {
  ...
  mustKnow: [
    ...
    "Kayıp Sakal şifresindeki Karayel, Yıldız, Poyraz sıcaklığı düşürür; Samyeli, Kıble, Lodos sıcaklığı artırır.",
    "Lodos rüzgarı kışın sıcaklıkları artırıp karları eriterek çığ riskine yol açar ve güneybatıdan estiği için baca zehirlenmelerine neden olur.",
    "En fazla yağış alan iklim Karadeniz (en çok sonbaharda), en kurak iklim karasaldır (en çok ilkbaharda). Erzurum-Kars ise en çok yağışı yazın alır.",
    "Güneydoğu Anadolu, buharlaşma şiddeti nedeniyle en kurak bölgemizdir.",
    "Endemik bitki (sadece o yöreye ait) bakımından en zengin yerimiz Toroslar'dır. Sığla ağacı Muğla'da yetişen en ünlü endemik türümüzdür."
  ],
  commonMistakes: [
    "Akdeniz ikliminin bitki örtüsü olan makilerin yaprakları dökülmez, sert ve tüylüdür. Bu durum kış ılıklığına değil, yaz kuraklığına karşı terlemeyi önleme adaptasyonudur.",
    "Karadeniz kıyılarında her mevsim yağış olması nemi artırır. Nem ise sıcaklık farkını azaltır. Karadeniz'de don olayı ve karın yerde kalma süresi karasal iklime göre çok daha azdır.",
    "Bozkır (step) ile çayır karıştırılmamalıdır. Bozkır ilkbaharda yeşerip yazın sararan kısa otlardır. Çayır ise yaz yağışlarıyla yaz boyunca yeşil kalan gür ve uzun boylu otlardır (Erzurum-Kars)."
  ],
  quickTimeline: [
    { date: "Miyosen", event: "Akdeniz iklimi ve Akdeniz bitki örtüsünün (Kızılçam ve makiler) Anadolu güneyinde yayılmaya başlaması." },
    { date: "Pleistosen", event: "Buzul çağlarında Avrupa'dan kaçan soğuk iklim bitkileri Anadolu'ya sığındı ve relikt (kalıntı) olarak günümüze ulaştı." },
    { date: "Holosen", event: "İnsan faaliyetlerinin başlamasıyla İç Anadolu ve Ergene Havzası'ndaki meşe ormanları tahrip edilerek antropojen bozkırlar oluştu." },
    { date: "Günümüz", event: "Küresel iklim değişikliği ve Basra alçak basıncının şiddetlenmesi nedeniyle iç kesimlerde kuraklık ve çölleşme riski artmaktadır." }
  ]
};
