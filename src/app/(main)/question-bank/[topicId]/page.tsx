...
export async function generateMetadata({ params, searchParams }: PageProps): Promise<Metadata> {
  ...
  const title = selectedTest?.title ?? (topic ? `${topic.title} Testleri` : "Karma KPSS Coğrafya Testleri");
  return {
    title,
    description: `${title} için Supabase'de hazır bekleyen açıklamalı KPSS Coğrafya testleri, seviye seçimi ve soru çözüm oturumu.`,
  };
}
