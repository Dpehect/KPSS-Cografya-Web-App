          ...
          <AnimatePresence mode="wait" initial={false}>
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <span className={cn("text-xs font-black", flipped ? "text-[var(--bureau-inverse-muted)]" : "text-[var(--bureau-muted)]")}>KPSS Coğrafya</span>
              </div>
                ...
                {!flipped && currentCard.imageUrl ? (
                  <div className="mt-6">
                    <img
                      ...
                      className="max-h-[220px] w-full rounded-2xl object-cover shadow-sm md:max-h-[280px]"
                    />
                  </div>
                ) : null}
              </div>
