...
const WELCOME_TEXT =
  "Merhaba. Ben KPSS Coğrafya Rehberi'yim. [ÖNEMLİ UYARI: Ben sadece konu/kavram tanımları ve 'nedir' tarzı bilgi sorularına cevap verebilirim.] Öğrenmek istediğiniz anayasal veya hukuki kavramı yazın, veritabanından tarayıp kaynak konu başlığıyla birlikte açıklayayım.";
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          text:
            response.ok && reply
              ? reply
              : "Şu an kısa bir bağlantı gecikmesi var. Sorunu farklı kelimelerle tekrar yaz; KPSS Coğrafya açısından en net şekilde açıklayayım.",
        },
      ]);
    } catch {
      setMessages((prev) => [
  ...
  return (
    <>
      <motion.button
        ...
        aria-label="KPSS Coğrafya Rehberi"
      ...
      <AnimatePresence>
        {open ? (
          <motion.section
            ...
            role="dialog"
            aria-label="KPSS Coğrafya Rehberi sohbet paneli"
          >
            ...
            <div className="border-t border-slate-200 bg-white p-3">
              ...
              <form onSubmit={handleSubmit} className="flex items-end gap-2 rounded-[22px] border border-slate-200 bg-slate-50 p-2 shadow-inner focus-within:border-blue-400 focus-within:ring-4 focus-within:ring-blue-500/10">
                <textarea
                  ...
                  placeholder="Coğrafya sorunu yaz: örn. Put kırıcı kimdir?"
                  disabled={loading}
                  rows={1}
