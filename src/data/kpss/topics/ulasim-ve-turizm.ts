...
export const ulasimveturizm: Topic = {
  ...
  era: "cagdas",
  shortDescription: "Türkiye'de karayolu, demiryolu, denizyolu ve havayolu ulaşım sistemleri, limanlar, geçitler, turizm çeşitliliği ve UNESCO kültürel miras alanları.",
  examImportance: 10,
  estimatedMinutes: 60,
...
,
  ...
  mustKnow: [
    ...
    "Doğu Karadeniz kıyıları, Antalya-Muğla çevresi, Çanakkale ve Hakkari'de demiryolu bağlantısı yoktur. Antalya demiryolu olmayan en büyük turizm şehridir.",
    "En ucuz ulaşım yolu denizyolu, en pahalısı havayoludur. Doğal liman olduğu halde hinterlandı dar olduğu için gelişmeyen limanımız Sinop'tur.",
    "Ordu-Giresun (OR-Gİ) ve Rize-Artvin havalimanları denizin doldurulmasıyla inşa edilmiş özel mühendislik projeleridir.",
    "UNESCO Karma Miras Listesi'nde yer alan alanlarımız Kapadokya (Nevşehir) ve Pamukkale-Hierapolis (Denizli) alanlarıdır.",
    "Türkiye'nin ilk milli parkı Yozgat Çamlığı Milli Parkı'dır."
  ],
  commonMistakes: [
    "Türkiye'de iç ticarette en ucuz yol denizyolu değildir. İç taşımacılıkta en çok karayolu kullanılır ancak en ucuz taşıma yöntemi (hem iç hem dış) demiryolu ve denizyoludur.",
    "Tüm Karadeniz kıyılarında demiryolu yok sanılır. Zonguldak ve Samsun limanlarında demiryolu bağlantısı vardır; sadece Doğu Karadeniz (Trabzon, Rize vb.) ve Sinop'ta demiryolu yoktur.",
    "Pamukkale Hierapolis sadece doğal miras değildir. Pamukkale travertenleri doğal, Hierapolis antik kenti ise kültürel miras olup ikisi birlikte karma miras kategorisindedir."
  ],
  quickTimeline: [
    { date: "1856", event: "İzmir-Aydın hattında Türkiye'nin (Osmanlı) ilk demiryolu hattının yapımına başlandı." },
    { date: "1985", event: "Göreme Milli Parkı ve Kapadokya, Türkiye'nin UNESCO Dünya Miras Listesi'ne giren ilk alanlarından biri oldu." },
    { date: "2009", event: "Ankara-Eskişehir hattı açılarak Türkiye'de ilk Yüksek Hızlı Tren (YHT) seferi gerçekleştirildi." },
    { date: "2015", event: "Deniz üzerine kurulan ilk havalimanı olan Ordu-Giresun Havalimanı (OR-Gİ) hizmete açıldı." },
    { date: "2018", event: "Şanlıurfa Göbeklitepe Arkeolojik Alanı, UNESCO Dünya Miras Listesi'ne resmen kabul edildi." }
  ]
};
