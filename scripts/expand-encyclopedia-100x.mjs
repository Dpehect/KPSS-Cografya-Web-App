...
export const islamiyetOncesiData: EncyclopediaEntry[] = [
  {
    ...
    "examImportance": "Yokluk (kurucu unsur eksikliği), mutlak butlan (emredici hükme aykırılık) ve nispi butlan (irade sakatlığı) farkları ve yaptırım türlerinin tanımları KPSS Coğrafya sınavlarında hemen hemen her yıl doğrudan soru olarak sorulmaktadır."
  },
  {
    ...
    "examImportance": "Fiil ehliyeti şartları, erginlik yaşları (yasal 18, evlenme ile 17/16, kaza-i rüşt 15) ve sınırlı ehliyetsizlerin yapması tamamen yasak olan işlemler (kefalet, bağış, vakıf kurma) KPSS Coğrafya sorularının en çok sorduğu konulardır."
  },
  {
  ...
  },
  {
    ...
    "examImportance": "Hangi hukuk dalının kamu, özel veya karma hukuk grubuna dahil olduğu, Medeni Hukukun alt dallarının neler olduğu (Kişiler, Aile, Eşya, Miras) ve kamu hukukunun kolları KPSS Coğrafya testlerinde en sık çıkan klasik sınıflandırma sorularındandır."
  },
  {
    "id": "borclar-hukuku",
    "category": "Temel Hukuk Bilgisi",
    ...
    "examImportance": "Borç ilişkisinin unsurları (Alacaklı, Borçlu, Edim), borcun kaynakları (Hukuki işlem, Haksız fiil, Sebepsiz zenginleşme) ve borçlar hukukuna hakim olan ilkeler (özellikle nispilik ve irade özgürlüğü) KPSS Coğrafya bölümünün en garanti soru alanlarındandır."
  },
  {
...
export const osmanliSiyasiData: EncyclopediaEntry[] = [
  ...
  },
  {
    ...
    "examImportance": "İlk Türk anayasası olması, çift meclisli yapısı (Mebusan ve Ayan) ve 1909 demokratik değişikliklerinin getirdiği yenilikler (hükümetin meclise sorumlu olması, sürgün yetkisinin kaldırılması) KPSS Coğrafya ve Tarih sınavlarının ortak ve çok önemli soru alanlarındandır."
  },
  {
    "id": "anayasa-1921",
    "category": "Anayasa Tarihi ve Devlet",
  ...
  },
  {
    ...
    "examImportance": "1924 Anayasası'nın karma hükümet yapısı, laikleşme adımlarının yılları (1928 din ibaresinin kalkması, 1937 ilkelerin eklenmesi), kadınların siyasi hakları kazanma sıralaması (Belediye 1930, Muhtar 1933, Milletvekili 1934) KPSS coğrafya anayasa tarihi bölümünün en popüler soru şablonlarıdır."
  },
  {
    "id": "anayasa-1961",
    "category": "Anayasa Tarihi ve Devlet",
...
export const osmanliKulturMedeniyetData: EncyclopediaEntry[] = [
  ...
  },
  {
    ...
    "examImportance": "Toplantı (200) ve asgari karar yeter sayısı (151) ile nitelikli kararların oy oranları (301, 360, 400) coğrafya anayasa hukuku testlerindeki en zorlayıcı sayısal soruların başında gelmektedir."
  },
  {
  ...
  },
  {
    ...
    "examImportance": "Kaldırılan denetim yolları (gensoru, sözlü soru), yazılı soru cevaplama süresi (15 gün) ve meclis soruşturması süreçlerindeki nitelikli oy oranları (301, 360, 400) KPSS Coğrafya bölümünün en klasik ve zorlayıcı sayısal sorularını oluşturur."
  }
];
`;
...
export const turkIslamData: EncyclopediaEntry[] = [
  {
    ...
    "examImportance": "Türkiye'nin NATO'ya giriş yılı (1952) ve sebebi (Kore Savaşı), kurucu üye olduğumuz kuruluşlar (BM, Avrupa Konseyi, İİT, KEİ) ile tam üye olmadığımız örgütler (AB, ŞİÖ) güncel bilgiler ve coğrafya genel kültür testlerinin en garanti soru kalıplarındandır."
  },
  {
